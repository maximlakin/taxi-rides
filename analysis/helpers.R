...
theme_dark_map = function(base_size = 18) {
  theme_bw(base_size) +
    theme(text = element_text(family = font_family, color = "#ffffff"),
          rect = element_rect(fill = "#203040", color = "#203040"),
          plot.background = element_rect(fill = "#203040", color = "#203040"),
          panel.background = element_rect(fill = "#203040", color = "#203040"),
          plot.title = element_text(family = title_font_family),
